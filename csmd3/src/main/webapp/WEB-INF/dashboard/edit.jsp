            ...
            <form class="ps-form--checkout" action="" method="post">
                <div class="row">
                                ...
                                <div class="form-group__content">
                                    <select name="type" class="form-control">
                                        <c:forEach items="${applicationScope.listType}" var="type">
                                            <option <c:if test="${food.getType() == type.getId()}">selected</c:if> value="${type.getId()}">${type.getName()}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="form-group paypal">
                        <button class="ps-btn ps-btn--yellow" style="margin-left: 300px;">Edit Food</button>
                    </div>
            </form>
        </div>
                </div>
